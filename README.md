...
**Authors:** Monica Rothwell & Mariam Abdulsalam
...
- **Biophysical Modelling:** Developed a model validated against PAM fluorometry data.
- **Data Analysis:** Processed time-series data to capture diurnal and seasonal fluctuations.
- **Validation:** Quantified the impact of environmental controls on photosynthetic light-use efficiency.
